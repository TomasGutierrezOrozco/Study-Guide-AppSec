...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/ldap", Main::ldap);
        server.createContext("/latex", Main::latex);
        server.start();
    }
    ...
    static void ldap(HttpExchange ex) throws IOException {
        write(ex, "(&(uid=" + param(ex, "user") + ")(role=user))");
    }

    static void latex(HttpExchange ex) throws IOException {
        write(ex, "\\documentclass{article}\n\\begin{document}\nHello " + param(ex, "name") + "\n\\end{document}");
    }
